...
class StageBGS extends GSInfo {
    ...
    function GetName()          { return "stageBhard"; }
    function GetShortName()     { return "STBH"; }
    function GetDescription()   { return "Hardened fixed half-adder SUM = a XOR b as a 6-gate NOR network on trains (robust g3 far-freeze)."; }
